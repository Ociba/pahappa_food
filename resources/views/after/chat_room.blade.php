...
<head>
  ...
  <meta name="author" content="PAHAPboard">
  <meta name="keyword" content="PAHAPboard, Bootstrap, Admin, Template, Theme, Responsive, Fluid, Retina">
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>PAHAP<span>PA</span></b></a>
      <!--logo end-->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="index.html#">
                  <div class="task-info">
                    <div class="desc">Pahappa Admin Panel</div>
          ...
          <aside class="mid-side">
            ...
            <div class="group-rom">
              ...
              <div class="second-part">
                ...
                <p><img class="img-responsive" src="{{asset('bootstrap/img/product.jpg')}}" alt=""></p>
              </div>
              <div class="third-part">12:32</div>
            </div>
            <div class="group-rom">
            ...
            <ul class="chat-available-user">
              <li>
                <a href="chat_room.html">
                  <img class="img-circle" src="{{asset('bootstrap/img/friends/fr-02.jpg')}}" width="32">
                  Paul Brown
              ...
              <li>
                <a href="chat_room.html">
                  <img class="img-circle" src="{{asset('bootstrap/img/friends/fr-05.jpg')}}" width="32">
                  David Duncan
              ...
              <li>
                <a href="chat_room.html">
                  <img class="img-circle" src="{{asset('bootstrap/img/friends/fr-07.jpg')}}" width="32">
                  Laura Smith
              ...
              <li>
                <a href="chat_room.html">
                  <img class="img-circle" src="{{asset('bootstrap/img/friends/fr-08.jpg')}}" width="32">
                  Julia Schultz
              ...
              <li>
                <a href="chat_room.html">
                  <img class="img-circle" src="{{asset('bootstrap/img/friends/fr-01.jpg')}}" width="32">
                  Frank Arias
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Pahappa</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
            You are NOT allowed to delete the credit link to Pahappa with free version.
            You can delete the credit link only if you bought the pro version.
            Buy the pro version with working PHP/AJAX contact form: https://Pahappa.com/Pahappa-bootstrap-admin-template/
            Licensing information: https://Pahappa.com/license/
          -->
          Created with Pahappa IT Department <a href="https://Pahappa.com/">Pahappa</a>
        </div>
