...
<head>
  ...
  <link href="{{asset('bootstrapcss/style-responsive.css')}}" rel="stylesheet">
</head>
...
<body onload="getTime()">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p class="centered"><img class="img-circle" width="80" src="{{asset('bootstrap/img/ui-sam.jpg')}}"></p>
  ...
  <script>
    $.backstretch("{{asset('bootstrap/img/login-bg.jpg')}}", {
      speed: 500
    });
  </script>
  <script>
